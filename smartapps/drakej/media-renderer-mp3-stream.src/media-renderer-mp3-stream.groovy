...
definition(
name: "Media Renderer Events /w Mp3 Streams",
namespace: "drakej",
author: "SmartThings & Jonathan Drake",
description: "Play a sound, mp3 url, Radionomy station, or custom message through your Sonos when the mode changes or other events occur.",
...
def mainPage() {
	dynamicPage(name: "mainPage") {
		...
		section{
			input "actionType", "enum", title: "Action?", required: true, defaultValue: "Message",submitOnChange:true, options: ["Message","Sound","Track","Custom","Radionomy","Multiple Radionomy"]
		}
...
private takeAction(evt) {
	...
	def radionomyStations = [["70s 4u":["key":"4u-70s","artURI":"https://i3.radionomy.com/radios/400/e9fa1d18-12eb-4202-b2b5-5bb9de4d7110.jpg","description":"70s 4u"]],
	...
	switch(actionType) {
		...
		break
		case "Custom":
		sonos.playTrackAndResume("http://192.168.1.6/jp.mp3", 24, volume)
